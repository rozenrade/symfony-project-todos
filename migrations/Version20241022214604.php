 ...
 */
final class Version20241022214604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD todo_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_527EDB25EA1EBC33 ON task');
        $this->addSql('ALTER TABLE task DROP todo_id');
    }
}
